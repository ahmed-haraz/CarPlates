...
public record BillAttachmentDto(long Id, long HeaderId, string FileName, string FilePath, string? ContentType, long? FileSize, string AttachmentType, long? InsertUserID, long? InsertDateTime, int Status);
